The code in this folder is a CUDA implementation of the sequential addition algorithm for obtaining (2,2)
separating codes. It has been developed and tested in a computer with an Intel 
...
in lines 56 and 61 of the file "main.cu". In order to obtain the code the code must be compiled 
